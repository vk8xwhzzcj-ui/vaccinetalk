          ...
          <div className="about-bilingual">
            ...
            <div className="about-lang arabic">
              ...
              <div className="about-lang-intro">
                <p>
                  دي ببساطة جرعة من تطعيم التهاب الكبدي الوبائي (ب)، مخافة إن الطفل يكون اتنقل له المرض أثناء الولادة، أو إن الأم أصلاً تكون حاملة للمرض.
                </p>
              </div>
              ...
              <div className="about-features">
                <div className="feature-item">
                  ...
                  <p>
                    <strong>مهم جداً:</strong> بس ناخد بالنا لو الأم مصابة بالفيروس لازم الطفل ياخد كمان الجلوبيولين المناعي لفيروس (ب) بعد الولادة مباشرة مع التطعيم، وبيتحقن التطعيم ساعتها في عضلة الفخذ، والجلوبيولين المناعي في عضلة الفخذ في الرجل التانية.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="about-lang">
              ...
              <div className="about-lang-intro">
                <p>
                  This is simply a dose of hepatitis B vaccine, in case the child contracted the disease during birth, or if the mother is already a carrier of the disease.
                </p>
              </div>
