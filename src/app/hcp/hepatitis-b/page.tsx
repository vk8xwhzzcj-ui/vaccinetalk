...
export default function HCPHepatitisB() {
  return (
        ...
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'flex-start'}}>
              ...
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>
                <strong>HBsAg</strong>: Surface antigen—marker of infectivity; indicates acute or chronic infection.
                <br/><strong>Anti-HBs</strong>: Antibody to surface antigen—marker of immunity (post-infection, post-vaccination, or passive antibody). Avoid abbreviation HBsAb to prevent confusion.
                <br/><strong>Anti-HBc (total)</strong>: Antibody to core antigen—nonspecific marker of acute, chronic, or resolved infection; not a marker of vaccine-induced immunity; useful for prevaccination screening.
                <br/><strong>IgM anti-HBc</strong>: Indicates recent (&lt;6 months) infection; marker of acute infection.
                <br/><strong>HBeAg</strong>: Marker of high infectivity; correlates with high viral replication; used in chronic HBV management.
                <br/><strong>Anti-HBe</strong>: May be present in infected or immune persons; in chronic infection suggests lower viral titer/infectivity.
                <br/><strong>HBV-DNA</strong>: Viral load; reflects replication and infectivity; used to assess and monitor chronic HBV treatment.
              </p>
              ...
              <h3 style={{textAlign: 'center', fontSize: '1.8rem', fontWeight: 600, color: '#40606D', marginTop: '2rem', marginBottom: '1rem', width: '100%', alignSelf: 'center'}}>
                Egypt: Hepatitis B Control Status
              </h3>
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>
              ...
              <p className="about-lang-intro" style={{fontSize: '0.9rem', fontStyle: 'italic', marginTop: '1.5rem'}}>
                References: 
                <a href="http://www.emro.who.int/egy/egypt-news/egypt-becomes-the-first-country-in-the-region-to-achieve-hepatitis-b-control-status.html" target="_blank" rel="noopener noreferrer" style={{color:'#40606D', textDecoration:'underline'}}>WHO EMRO News</a> | 
                <a href="https://www.immunize.org/ask-experts/topic/hepb/" target="_blank" rel="noopener noreferrer" style={{color:'#40606D', textDecoration:'underline'}}>Immunize.org HepB</a> | 
                <a href="https://www.sis.gov.eg/Story/209048/Egypt-first-in-Africa-to-control-hepatitis-B%2C-Minister-of-Health?lang=" target="_blank" rel="noopener noreferrer" style={{color:'#40606D', textDecoration:'underline'}}>Egypt State Info Service</a> | 
                <a href="https://www.who.int/health-topics/hepatitis#tab=tab_1" target="_blank" rel="noopener noreferrer" style={{color:'#40606D', textDecoration:'underline'}}>WHO: Hepatitis</a>
              </p>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Hep B Serum PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/Heb%20b%20serum.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
