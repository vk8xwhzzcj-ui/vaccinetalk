          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'flex-start'}}>
              ...
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>
                The standard Twinrix (HepA‑HepB) series consists of three intramuscular doses at <strong>0, 1, and 6 months</strong>. Minimum intervals:
              </p>
              <ul className="about-lang-intro" style={{paddingLeft: '1.2rem', direction: 'ltr', textAlign: 'left'}}>
                <li>Between Dose 1 and Dose 2: <strong>at least 4 weeks (28 days)</strong></li>
                <li>Between Dose 2 and Dose 3: <strong>at least 5 months (~20 weeks)</strong></li>
              </ul>
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>These intervals ensure optimal immune response to both hepatitis A and B.</p>

              <h3 style={{textAlign: 'left', fontSize: '1.3rem', fontWeight: 600, color: '#40606D', marginTop: '1.5rem', marginBottom: '0.5rem'}}>
                Accelerated (Alternative) Twinrix Schedule for Rapid Protection
              </h3>
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>
                For rapid protection (e.g., imminent travel), an accelerated 4‑dose schedule may be used:<br />
                First dose: <strong>Day 0</strong><br />
                Second dose: <strong>Day 7</strong><br />
                Third dose: <strong>Day 21–30</strong><br />
                Fourth (booster) dose: <strong>≥12 months</strong> after the first dose<br />
              ...
              <p className="about-lang-intro" style={{direction: 'ltr', textAlign: 'left'}}>
                If Twinrix is started but completion with single‑antigen vaccines is needed:<br />
                If <strong>1 dose</strong> of Twinrix was given:<br />
                Complete with <strong>2 adult doses</strong> of Hepatitis A (HepA)<br />
                Complete with <strong>2 adult doses</strong> of Hepatitis B (HepB)<br />
                If <strong>2 doses</strong> of Twinrix were given:<br />
                Complete with <strong>1 adult dose</strong> of HepA<br />
                Complete with <strong>1 adult dose</strong> of HepB
              </p>
              <h4 style={{textAlign: 'left', fontSize: '1.1rem', fontWeight: 600, color: '#40606D', marginTop: '1.5rem', marginBottom: '0.5rem'}}>
                Key principles:
              </h4>
              <ul className="about-lang-intro" style={{paddingLeft: '1.2rem', direction: 'ltr', textAlign: 'left'}}>
                <li>Each Twinrix dose contains an adult dose of <strong>HepB</strong> and a paediatric dose of <strong>HepA</strong>.</li>
                <li>A Twinrix dose can substitute for any dose in the <strong>HepB</strong> series, but not for a full adult dose in the <strong>HepA</strong> series.</li>
                <li>Any combination of <strong>3 doses</strong> of adult HepB or <strong>3 doses</strong> of Twinrix constitutes a complete HepB series.</li>
                <li><strong>1 Twinrix</strong> dose + <strong>2 adult HepA</strong> doses = complete HepA series.</li>
                <li><strong>2 Twinrix</strong> doses + <strong>1 adult HepA</strong> dose = complete HepA series.</li>
              </ul>

              <p className="about-lang-intro" style={{fontSize: '0.9rem', fontStyle: 'italic', marginTop: '1rem'}}>
                Reference: <a href="https://www.immunize.org/ask-experts/topic/combo-vaccines/hepa-hepb/" target="_blank" rel="noopener noreferrer" style={{color:'#40606D', textDecoration:'underline'}}>Immunize.org – HepA‑HepB (Twinrix) guidance</a>
              </p>
