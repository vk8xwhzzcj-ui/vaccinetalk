...
export default function FAQ() {
  return (
    <div className="min-h-screen">
      ...
      <section className="about-section" style={{height: '5cm', minHeight: '5cm', maxHeight: '5cm', overflow: 'hidden', padding: '1rem 0'}}>
        <div className="about-elegant-card" style={{height: '100%', minHeight: '100%'}}>
          ...
          <div className="coming-soon-container">
            <div className="coming-soon-content">
              ...
              <p className="coming-soon-message">
                ...
                <span className="coming-soon-text">We're working on preparing the FAQ section</span>
              </p>
            </div>
          </div>
        </div>
