...
export default function Diphtheria() {
  return (
          ...
          <div className="about-bilingual">
            ...
            <div className="about-lang arabic">
              ...
              <div className="about-lang-intro">
                <p>
                  مرض بيصيب الجهاز التنفسي وبيعمل تورم في منطقة الحلق، وبيبقى ساعتها التنفس والبلع صعب جدا.
                </p>
              </div>
              ...
              <div className="about-features">
                ...
                <div className="feature-item">
                  ...
                  <p>
                    التطعيم اجباري عند سن شهرين، أربعة، ستة وكمان عند سنة ونص جوه تطعيم الثلاثي والخماسي والسداسي.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">🏫</span>
                  <p>
                    ده غير حملات تطعيم المدارس اللي بتنظمها وزارة الصحة المصرية بالمجان في سنة تانية ورابعة ابتدائي.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">👥</span>
                  <p>
                    كمان الكبار من الحوامل، المسافرين، بعض المرضى والحالات الخاصة بينصحوهم ياخدوا جرعات منشطة من الثنائي أو الثلاثي اللاخلوي.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="about-lang">
              ...
              <div className="about-lang-intro">
                <p>
                  A disease that affects the respiratory system and causes swelling in the throat area, making breathing and swallowing very difficult.
                </p>
              </div>
              ...
              <div className="about-features">
                ...
                <div className="feature-item">
                  <span className="feature-emoji">📅</span>
                  <p>
                    The vaccine is mandatory at 2, 4, 6 months and also at 18 months as part of the triple, pentavalent, and hexavalent vaccines.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">🏫</span>
                  <p>
                    In addition to school vaccination campaigns organized by the Egyptian Ministry of Health free of charge in 2nd and 4th grade.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">👥</span>
                  <p>
                    Also, adults including pregnant women, travelers, some patients, and special cases are advised to take booster doses of the diphtheria-tetanus or acellular triple vaccine.
                  </p>
                </div>
              </div>
            </div>
