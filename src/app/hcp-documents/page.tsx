...
export default function HCPDocuments() {
  return (
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'flex-start'}}>
              ...
              <div className="documents-grid">
                <a href="/doc/storage">Storage</a>
                <a href="/doc/administration-scheduling-contraindications">Administration Scheduling and Contraindications</a>
                <a href="/doc/hepatitis-a">Hepatitis A</a>
                <a href="/doc/hepatitis-b">Hepatitis B</a>
                <a href="/doc/hpv">HPV</a>
                <a href="/doc/influenza">Influenza</a>
                <a href="/doc/meningococcal-acwy">Meningococcal ACWY</a>
