        ...
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            <div className="about-lang">
              ...
              <p className="about-lang-intro">
                Vaccination is not just about personal protection — it plays a key role in public health, contributing to the safety of entire populations. This section offers an easy-to-understand introduction to vaccines and answers key questions about their function, development, and use.
              </p>
              <p className="about-lang-intro vaccination-basics-subtitle">
                Explore the subtopics below to learn more:
              </p>
              <div className="vaccination-basics-grid">
                <a href="/hcp-how-vaccines-work">How do vaccines work?</a>
                <a href="/hcp-herd-immunity">Herd immunity</a>
                <a href="/hcp-types-of-vaccines">Types of vaccines</a>
                <a href="/hcp-vaccine-administration">Vaccine administration</a>
                <a href="/hcp-vaccine-composition">Vaccine composition</a>
                <a href="/hcp-vaccine-release">Vaccine release</a>
              </div>
            </div>
          </div>
        </div>
