            ...
            <div className="about-bilingual">
              <div className="about-lang arabic">
                ...
                <div className="about-lang-intro">
                  <p>
                    ده بيكون تطعيم للوقاية من الأمراض اللي بتسببها بكتيريا Streptococcus pneumoniae واللي أشهرها الإلتهاب الرئوي.
                  </p>
                </div>
                <div className="about-features">
                  <div className="feature-item">
                    ...
                    <p>
                      التطعيم مينفعش للأطفال تحت سن سنتين، ده لان جسمهم مبيعرفش يتعرف علي التطعيم وبالتالي مبيعملش مناعة كفاية، ده غير إننا بنضطر نعيده كل شويه لإنه متعدد السكريات.
                    </p>
                  </div>
                  <div className="feature-item">
                    <span className="feature-emoji">📅</span>
                    <p>
                      بيتاخد بعد تطعيم المكورات الرئوية بشهرين أو سنة حسب الحالة.
                    </p>
                  </div>
                  <div className="feature-item">
                    <span className="feature-emoji">💉</span>
                    <p>
                      ممكن يتحقن تحت الجلد أو في عضلة الكتف.
                    </p>
                  </div>
                  <div className="feature-item">
                    <span className="feature-emoji">⚠️</span>
                    <p>
                      <strong>موانع التطعيم:</strong> ارتفاع درجة حرارة المتلقي والأطفال أقل من سن سنتين.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="about-lang">
                ...
                <div className="about-features">
                  <div className="feature-item">
                    <span className="feature-emoji">🚫</span>
                    <p>
                      This vaccine is not suitable for children under 2 years of age, because their bodies cannot recognize the vaccine and therefore do not produce adequate immunity. Additionally, it needs to be repeated periodically because it is polysaccharide-based.
                    </p>
                  </div>
                  <div className="feature-item">
                    <span className="feature-emoji">📅</span>
                    <p>
                      It is given 2 months or 1 year after the pneumococcal vaccine, depending on the case.
                    </p>
                  </div>
                  <div className="feature-item">
                    <span className="feature-emoji">💉</span>
                    <p>
                      It can be injected subcutaneously or into the shoulder muscle.
                    </p>
                  </div>
                  <div className="feature-item">
                    <span className="feature-emoji">⚠️</span>
                    <p>
                      <strong>Contraindications:</strong> High fever in the recipient and children under 2 years of age.
                    </p>
                  </div>
                </div>
              </div>
