          ...
          <div className="about-bilingual">
            ...
            <div className="about-lang arabic">
              ...
              <div className="about-lang-intro">
                <p>
                  عدوى فيروسية بتصيب الكبد، وممكن يتطور المرض ويسبب تليف وسرطان الكبد.
                </p>
              </div>
              ...
              <div className="about-features">
                <div className="feature-item">
                  ...
                  <p>
                    بيتنقل عن طريق الدم وسوائل الجسم.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">📅</span>
                  <p>
                    التطعيم اجباري عند الولادة وعمر شهرين،أربعة وستة.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  ...
                  <p>
                    ده غير الكبار اللي لم يسبق لهم التطعيم من قبل لازم ياخدوه خصوصا لو كانوا بيشتغلوا في المجال الطبي أو مخالطين لمريض حامل للفيروس بس هنديه بجدول تاني مختلف بيحدده الطبيب.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">🚫</span>
                  <p>
                    مفيش موانع من التطعيم إلا ارتفاع درجة الحرارة أو الحساسية من أي مكون بداخل التطعيم.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="about-lang">
              ...
              <div className="about-lang-intro">
                <p>
                  A viral infection that affects the liver, and the disease can progress and cause cirrhosis and liver cancer.
                </p>
              </div>
              ...
              <div className="about-features">
                ...
                <div className="feature-item">
                  <span className="feature-emoji">📅</span>
                  <p>
                    The vaccine is mandatory at birth and at 2, 4, and 6 months of age.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">👨‍⚕️</span>
                  <p>
                    As for adults who have not been vaccinated before, they must take it, especially if they work in the medical field or are in contact with a patient carrying the virus, but it will be given on a different schedule determined by the doctor.
                  </p>
                </div>
