        ...
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{direction: 'ltr', textAlign: 'left'}}>
              ...
              <p className="about-lang-intro" style={{textAlign: 'left', direction: 'ltr'}}>
                The immune system uses your white blood cells to fight infection.These white blood cells consist primarily of <strong>macrophages</strong>, <strong>B-lymphocytes</strong>, and <strong>T-lymphocytes</strong>: <strong>Macrophages</strong> are white blood cells that swallow up and digest germs, plus dead or dying cells. The <strong>macrophages</strong> leave behind parts of the invading germs called antigens. The body identifies antigens as dangerous and stimulates antibodies to attack them. <strong>B-lymphocytes</strong> are defensive white blood cells; they can produce antibodies to fight off infection. <strong>T-lymphocytes</strong> are another type of defensive white blood cell, that recognizes a familiar germ, if the body is exposed again to the same disease.
              </p>
              <p className="about-lang-intro" style={{textAlign: 'left', direction: 'ltr'}}>
                The first time the body is infected with a certain pathogen, it can take several days for the immune system to make and use all the tools needed to fight the infection. After the infection, the immune system remembers what it learned about how to protect the body against that disease. If your body encounters the same germ again, the <strong>T-lymphocytes</strong> recognize the familiar pathogen, and the <strong>B-lymphocytes</strong> can produce antibodies to fight off infection.
              </p>
              <p className="about-lang-intro" style={{textAlign: 'left', direction: 'ltr'}}>
                Vaccines can help protect against certain diseases by imitating an infection. This type of imitation infection helps teach the immune system how to fight off a future infection. Sometimes, after getting a vaccine, the imitation infection can cause minor symptoms, such as fever. Such minor symptoms are normal and should be expected as the body builds immunity. Then the vaccinated body is left with a supply of <strong>T-lymphocytes</strong> and <strong>B-lymphocytes</strong> that will remember how to fight that disease.
              </p>
              <p className="about-lang-intro" style={{textAlign: 'left', direction: 'ltr'}}>
                However, it typically takes a few weeks for the body to produce <strong>T-lymphocytes</strong> and <strong>B-lymphocytes</strong> after vaccination. Therefore, it is possible that a person infected with a disease just before or just after vaccination could develop symptoms and get that disease, because the vaccine has not had enough time to provide protection. While vaccines are the safest way to protect a person from a disease, no vaccine is perfect. It is possible to get a disease even when vaccinated, but the person is less likely to become seriously ill.
              </p>
            </div>
          </div>
        </div>
