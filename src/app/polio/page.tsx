          ...
          <div className="about-bilingual">
            ...
            <div className="about-lang arabic">
              ...
              <div className="about-lang-intro">
                <p>
                  مرض يؤثر على النخاع الشوكي، وممكن يتطور المرض وينتهي بفقدان القدرة علي الحركة.
                </p>
              </div>
              ...
              <div className="about-features">
                <div className="feature-item">
                  ...
                  <p>
                    بيتم تطعيم الأطفال ضد شلل الاطفال في صورة نقط وحقن.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">📅</span>
                  <p>
                    النقط مش بس بتتاخد في الشهر الثاني والرابع والسادس، لكن كمان في الشهر التاسع وفي عمر سنة، وسنة ونصف وعند الولادة.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">💉</span>
                  <p>
                    أما الحقن فبتكون عند شهرين وأربعة وستة.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">💉</span>
                  <p>
                    تطعيم شلل الأطفال الحقن ممكن يبقي لوحده أو جوه تطعيم السداسي.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="about-lang">
              ...
              <div className="about-lang-intro">
                <p>
                  A disease that affects the spinal cord, and the disease can progress and end with loss of the ability to move.
                </p>
              </div>
              ...
              <div className="about-features">
                <div className="feature-item">
                  <span className="feature-emoji">💧</span>
                  <p>
                    Children are vaccinated against polio in the form of drops and injections.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">📅</span>
                  <p>
                    The drops are not only taken in the 2nd, 4th, and 6th months, but also in the 9th month, at one year, one and a half years, and at birth.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">💉</span>
                  <p>
                    As for the injections, they are given at 2, 4, and 6 months.
                  </p>
                </div>
                ...
                <div className="feature-item">
                  <span className="feature-emoji">💉</span>
                  <p>
                    The polio injection vaccine can be given alone or as part of the hexavalent vaccine.
                  </p>
                </div>
              </div>
            </div>
