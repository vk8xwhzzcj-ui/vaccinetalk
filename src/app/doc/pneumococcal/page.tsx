...
export default function upneumococcalDoc() {
  return (
    <div className="min-h-screen">
      ...
      {/* PDF: Recommendations for Pneumococcal Vaccines Use in Children and Teens */}
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  src="/pneumo/Recommendations%20for%20Pneumococcal%20Vaccines%20Use%20in%20Children%20and%20Teens.pdf"
                  width="100%"
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Recommendations for Pneumococcal Vaccines Use in Children and Teens PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/pneumo/Recommendations%20for%20Pneumococcal%20Vaccines%20Use%20in%20Children%20and%20Teens.pdf"
                    download
                    style={{
      ...
      {/* PDF: Administering Pneumococcal Vaccines to Children and Teens */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              <h2 className="about-lang-title" style={{textAlign: 'center', fontSize: '2.5rem', alignSelf: 'center'}}>
                Administering Pneumococcal Vaccines to Children and Teens
              </h2>
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  src="/pneumo/Administering%20Pneumococcal%20Vaccines%20to%20Children%20and%20Teens.pdf"
                  width="100%"
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Administering Pneumococcal Vaccines to Children and Teens PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/pneumo/Administering%20Pneumococcal%20Vaccines%20to%20Children%20and%20Teens.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Pneumococcal Vaccine Timing for Adults */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Pneumococcal Vaccine Timing for Adults PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/pneumo/Pneumococcal%20Vaccine%20Timing%20for%20Adults.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Administering Pneumococcal Vaccines to Adults */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              <h2 className="about-lang-title" style={{textAlign: 'center', fontSize: '2.5rem', alignSelf: 'center'}}>
                Administering Pneumococcal Vaccines to Adults
              </h2>
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Administering Pneumococcal Vaccines to Adults PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/pneumo/Administering%20Pneumococcal%20Vaccines%20to%20Adults.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Use of 15-Valent and 20-Valent Pneumococcal Conjugate Vaccines Among Adults (MMWR) */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              <h2 className="about-lang-title" style={{textAlign: 'center', fontSize: '2.5rem', alignSelf: 'center'}}>
                Use of 15-Valent and 20-Valent Pneumococcal Conjugate Vaccines Among Adults (MMWR)
              </h2>
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Use of 15-Valent and 20-Valent Pneumococcal Conjugate Vaccines Among Adults MMWR PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/pneumo/Use%20of%2015-Valent%20Pneumococcal%20Conjugate%20Vaccine%20and%2020-Valent%20Pneumococcal%20among%20adults%20(MMWR).pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
