...
export default function HepatitisBDoc() {
  return (
    <div className="min-h-screen">
      ...
      {/* PDF: Hepatitis B and Healthcare Personnel */}
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  title="Hepatitis B and Healthcare Personnel PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/hepatitis%20b/Hepatitis%20B%20and%20Healthcare%20Personnel.pdf"
                    download
                    style={{
