...
export default function uinfluenzaDoc() {
  return (
    <div className="min-h-screen">
      ...
      {/* PDF: GCFLU Quadrivalent Periodic Benefit Risk Evaluation Report */}
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              <h2 className="about-lang-title" style={{textAlign: 'center', fontSize: '2.5rem', alignSelf: 'center'}}>
                GCFLU Quadrivalent Periodic Benefit Risk Evaluation Report
              </h2>
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  title="GCFLU Quadrivalent Periodic Benefit Risk Evaluation Report PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/flu/PERIODIC%20BENEFIT%20RISK%20EVALUATION%20REPORT%20FOR-%20GCFLU%20Quadrivalent%20Pre-filled%20Syringe%20inj..pdf"
                    download
                    style={{
