...
export default function AdministrationSchedulingContraindicationsDoc() {
  return (
    <div className="min-h-screen">
      ...
      <div style={{width: '100%', display: 'flex', justifyContent: 'center', margin: '0.5rem 0'}}>
        <h2 className="about-lang-title" style={{textAlign: 'center', fontSize: '2.5rem', margin: 0}}>
          Administration Scheduling and Contraindications
        </h2>
      </div>

      {/* PDF: Timing and Spacing of Immunobiologics */}
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  title="Timing and Spacing of Immunobiologics PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/admin/Timing%20and%20Spacing%20of%20Immunobiologics.pdf"
                    download
                    style={{
      ...
      {/* PDF: Guide to Contraindications and Precautions to Commonly Used Vaccines for All Ages */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Guide to Contraindications and Precautions to Commonly Used Vaccines for All Ages PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/admin/Guide%20to%20Contraindications%20and%20Precautions%20to%20Commonly%20Used%20Vaccines%20for%20All%20Ages.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Guide to Contraindications and Precautions to Commonly Used Vaccines in Adults */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Guide to Contraindications and Precautions to Commonly Used Vaccines in Adults PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/admin/Guide%20to%20Contraindications%20and%20Precautions%20to%20Commonly%20Used%20Vaccines%20in%20Adults.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Injectable Routes PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/admin/Injectable%20routes%20.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Vaccines with Diluents PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/admin/Vaccines%20with%20Diluents.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Medical Management of Vaccine Reactions in Children and Teens */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Medical Management of Vaccine Reactions in Children and Teens PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/admin/Medical%20Management%20of%20Vaccine%20Reactions%20in%20Children%20and%20Teens.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Medical Management of Vaccine Reactions in Adults */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Medical Management of Vaccine Reactions in Adults PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/admin/Medical%20Management%20of%20Vaccine%20Reactions%20in%20Adults.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Fainting Related to Vaccination */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              <h2 className="about-lang-title" style={{textAlign: 'center', fontSize: '2.5rem', alignSelf: 'center'}}>
                Fainting Related to Vaccination
              </h2>
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Fainting Related to Vaccination PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/admin/Fainting%20Related%20to%20Vaccination.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Needlestick Injury Management */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Needlestick Injury Management PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/admin/Needlestick%20Injury%20Management.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Latex in Vaccine Packaging */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Latex in Vaccine Packaging PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/admin/Latex%20in%20Vaccine%20Packaging%20.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
