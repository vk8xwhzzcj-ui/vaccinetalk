...
export default function umeningococcalubDoc() {
  return (
    <div className="min-h-screen">
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                ...
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/men%20b/MMWR%20Meningococcal%20Vaccination.pdf"
                    download
                    style={{
      ...
      {/* PDF: A Review of the Epidemiology of Invasive Meningococcal Disease and Vaccination Strategies in North Africa */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="A Review of the Epidemiology of Invasive Meningococcal Disease and Vaccination Strategies in North Africa PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/men%20b/menb-epidemiology-north-africa.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Bexsero EMA PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/men%20b/Bexsero%20(EMA).pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Bexsero Consumer Medicine Information */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              <h2 className="about-lang-title" style={{textAlign: 'center', fontSize: '2.5rem', alignSelf: 'center'}}>
                Bexsero Consumer Medicine Information
              </h2>
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Bexsero Consumer Medicine Information PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/men%20b/Bexsero%20Consumer%20Medicine%20Information.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
