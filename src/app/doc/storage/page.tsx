...
export default function StorageDoc() {
  return (
    <div className="min-h-screen">
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  title="Storage Factsheet PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/storage/storage%20factsheet.pdf"
                    download
                    style={{
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Temperature Monitoring PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/storage/temperature%20monitoring.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Vaccine Stability Table PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/storage/vaccine%20stability%20table.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Vaccine Storage Temperature */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Vaccine Storage Temperature PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/storage/vaccine%20storage%20temp..pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Vaccine Transportation PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/storage/vaccine%20transportation.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
