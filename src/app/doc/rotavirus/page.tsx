...
export default function urotavirusDoc() {
  return (
    <div className="min-h-screen">
      ...
      {/* PDF: WHO Position Paper on Rotavirus */}
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              <h2 className="about-lang-title" style={{textAlign: 'center', fontSize: '2.5rem', alignSelf: 'center'}}>
                WHO Position Paper on Rotavirus
              </h2>
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  title="WHO Position Paper on Rotavirus PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/rota/WHO%20position%20paper.pdf"
                    download
                    style={{
      ...
      {/* PDF: Rota Vaccine and Food Allergy */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Rota Vaccine and Food Allergy PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/rota/Rota%20vaccine%20and%20food%20allergy.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Rotavirus Genotypes Associated with Acute Diarrhea in Egyptian Infants */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Rotavirus Genotypes Associated with Acute Diarrhea in Egyptian Infants PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/rota/Rotavirus%20Genotypes%20Associated%20with%20Acute%20Diarrhea%20in%20Egyptian%20Infants.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
      ...
      {/* PDF: Clinical and Environmental Surveillance of Rotavirus Common Genotypes Showed High Prevalence of Common P Genotypes in Egypt */}
      <section className="about-section">
        <div className="about-elegant-card">
          <div className="card-corner card-corner-tl"></div>
          <div className="card-corner card-corner-tr"></div>
            ...
            <div className="about-lang" style={{alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
              ...
              <div style={{width: '100%', marginTop: '2rem'}}>
                <iframe
                  ...
                  height="800px"
                  style={{border: 'none', borderRadius: '8px'}}
                  title="Clinical and Environmental Surveillance of Rotavirus Common Genotypes Showed High Prevalence of Common P Genotypes in Egypt PDF"
                />
                <div style={{marginTop: '1rem', textAlign: 'center'}}>
                  <a
                    href="/rota/rota-surveillance-egypt.pdf"
                    download
                    style={{
                      display: 'inline-block',
                      padding: '0.75rem 2rem',
