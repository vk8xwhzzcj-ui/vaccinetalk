          ...
          <div className="about-bilingual">
            ...
            <div className="about-lang arabic">
              ...
              <div className="image-wrapper" style={{ marginBottom: '2rem', width: '100%', display: 'flex', justifyContent: 'center', background: 'transparent' }}>
                <img 
                  src="/2%20month%20old%20baby.jpeg" 
                  alt="عند الميلاد" 
              ...
              <div className="about-lang-intro">
                <p>
                  التطعيمات الأساسية التي تُعطى للطفل فور ولادته لحمايته من الأمراض الخطيرة.
                </p>
              </div>
              ...
              <div className="vaccination-section-buttons">
                ...
                <a href="/tuberculosis" className="vaccination-button">
                  <span className="button-emoji">🦠</span>
                  <span className="button-text">الدرن</span>
                  <span className="button-text-en">Tuberculosis</span>
                </a>
                
                <a href="/zero-dose" className="vaccination-button">
                  <span className="button-emoji">💉</span>
            ...
            <div className="about-lang">
              ...
              <div className="about-lang-intro">
                <p>
                  Essential vaccines given to the child immediately after birth to protect against serious diseases.
                </p>
              </div>
              ...
              <div className="vaccination-section-buttons">
                ...
                <a href="/tuberculosis" className="vaccination-button">
                  <span className="button-emoji">🦠</span>
                  <span className="button-text">Tuberculosis</span>
                  <span className="button-text-en">Tuberculosis</span>
                </a>
                
                <a href="/zero-dose" className="vaccination-button">
                  <span className="button-emoji">💉</span>
                  <span className="button-text">Zero Dose</span>
                  <span className="button-text-en">Zero Dose</span>
                </a>
              </div>
            </div>
