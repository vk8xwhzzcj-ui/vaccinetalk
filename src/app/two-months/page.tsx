          ...
          <div className="about-bilingual">
            ...
            <div className="about-lang arabic">
              ...
              <div className="about-lang-intro">
                <p>
                  التطعيمات المطلوبة في عمر الشهرين، مقسمة إلى إجبارية وإضافية.
                </p>
              </div>
            ...
            <div className="about-lang">
              ...
              <div className="about-lang-intro">
                <p>
                  Required vaccines at two months of age, divided into mandatory and additional.
                </p>
              </div>
