          ...
          <div className="about-bilingual">
            ...
            <div className="about-lang arabic">
              ...
              <div className="image-wrapper" style={{ marginBottom: '2rem', width: '100%', display: 'flex', justifyContent: 'center', background: 'transparent' }}>
                <img 
                  src="/1year%20old%20baby%20with%20black%20eyes%20not%20eastern%20but%20from%20egypt.jpeg" 
                  alt="سنة" 
              ...
              <div className="about-lang-intro">
                <p>
                  التطعيمات المطلوبة في عمر السنة، مقسمة إلى إجبارية وإضافية.
                </p>
              </div>
            ...
            <div className="about-lang">
              ...
              <div className="about-lang-intro">
                <p>
                  Required vaccines at one year of age, divided into mandatory and additional.
                </p>
              </div>
