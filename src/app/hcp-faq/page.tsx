          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems:'flex-start', width:'100%'}}>
              <div className="faq-grid">
                {[
                  {label:'Hepatitis A', href:'/faq/hepatitis-a'},
                  {label:'Hepatitis B', href:'/faq/hepatitis-b'},
                  {label:'(HepA+HepB)', href:'/faq/hepa-hepb'},
                  {label:'Hib', href:'/faq/hib'},
                  {label:'HPV', href:'/faq/hpv'},
                  {label:'Influenza', href:'/faq/influenza'},
                  {label:'MMR', href:'/faq/mmr'},
                  {label:'Meningococcal (ACWY)', href:'/faq/meningococcal-acwy'},
                  {label:'Meningococcal (B)', href:'/faq/meningococcal-b'},
                  {label:'Pneumococcal', href:'/faq/pneumococcal'},
                  {label:'Rabies', href:'/faq/rabies'},
                  {label:'Rotavirus', href:'/faq/rotavirus'},
                  {label:'RSV', href:'/faq/rsv'},
                  {label:'Varicella', href:'/faq/varicella'},
                  {label:'Herpes zoster', href:'/faq/zoster'},
                  {label:'Scheduling', href:'/faq/scheduling'},
                  {label:'Administering Vaccines', href:'/faq/administering-vaccines'},
                  {label:'Contraindication & Precautions', href:'/faq/contraindications-precautions'},
                ].map((btn, i) => (
                  <a 
                    key={btn.href} 
                    href={btn.href}
                    style={{
                      background: i % 2 === 0 ? '#40606D' : 'rgba(255,255,255,0.6)',
                      color: i % 2 === 0 ? '#fff' : '#333',
                      border: i % 2 === 0 ? 'none' : '2px solid rgba(139,115,85,0.2)'
                    }}
                  >
                    {btn.label}
                  </a>
