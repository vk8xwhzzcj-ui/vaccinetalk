        ...
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{direction: 'ltr', textAlign: 'left'}}>
              ...
              <p className="about-lang-intro" style={{textAlign: 'left', direction: 'ltr'}}>
                <strong>Vaccinating not only protects yourself, but also protects those in the community who are unable to be vaccinated. If you are able to, get vaccinated.</strong>
              </p>
            </div>
          </div>
        </div>
