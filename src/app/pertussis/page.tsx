          ...
          <div className="about-bilingual">
            ...
            <div className="about-lang arabic">
              ...
              <div className="about-lang-intro">
                <p>
                  مرض شديد العدوى بيصيب الجهاز التنفسي، وبنقدر نميزه بصوت الكحة الشديدة اللي بتبقى زي صوت الديك.
                </p>
              </div>
              ...
              <div className="about-features">
                <div className="feature-item">
                  ...
                  <p>
                    <strong>التطعيم إجباري:</strong> التطعيم بيكون اجباري عند سن شهرين، أربعة، ستة وكمان عند سنة ونص جوه تطعيم الثلاثي والخماسي والسداسي.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="about-lang">
              ...
              <div className="about-lang-intro">
                <p>
                  A highly contagious disease that affects the respiratory system, and we can distinguish it by the severe cough sound that resembles a rooster's crow.
                </p>
              </div>
              ...
              <div className="about-features">
                <div className="feature-item">
                  <span className="feature-emoji">💉</span>
                  <p>
                    <strong>Mandatory Vaccination:</strong> The vaccine is mandatory at 2 months, 4 months, 6 months, and also at 1.5 years as part of the triple, pentavalent, and hexavalent vaccines.
                  </p>
                </div>
              </div>
            </div>
