  ...
  return (
    <div className="min-h-screen">
      ...
      <section style={{padding:'0.5rem 1rem 0'}}>
        <h2 className="about-lang-title" style={{textAlign:'center', fontSize:'2rem', margin:'0'}}>Copyright & Content Policy</h2>
      </section>

      {/* Copyright Summary Section */}
      <section className="about-section">
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            ...
            {/* Divider */}
            <div className="lang-divider" style={{margin: '1.5rem 0'}}></div>
