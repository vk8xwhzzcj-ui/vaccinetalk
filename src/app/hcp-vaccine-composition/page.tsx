        ...
        <div className="about-elegant-card">
          ...
          <div className="about-bilingual">
            <div className="about-lang" style={{alignItems: 'flex-start'}}>
              ...
              <h3 style={{fontSize: '1.3rem', fontWeight: '700', marginTop: '1.5rem', marginBottom: '0.5rem', color: '#40606D', textAlign: 'left'}}>Antigen</h3>
              <p className="about-lang-intro">
              ...
              <h3 style={{fontSize: '1.3rem', fontWeight: '700', marginTop: '1.5rem', marginBottom: '0.5rem', color: '#40606D', textAlign: 'left'}}>Preservatives</h3>
              <p className="about-lang-intro">
              ...
              <h3 style={{fontSize: '1.3rem', fontWeight: '700', marginTop: '1.5rem', marginBottom: '0.5rem', color: '#40606D', textAlign: 'left'}}>Stabilizers</h3>
              <p className="about-lang-intro">
              ...
              <h3 style={{fontSize: '1.3rem', fontWeight: '700', marginTop: '1.5rem', marginBottom: '0.5rem', color: '#40606D', textAlign: 'left'}}>Surfactants</h3>
              <p className="about-lang-intro">
              ...
              <h3 style={{fontSize: '1.3rem', fontWeight: '700', marginTop: '1.5rem', marginBottom: '0.5rem', color: '#40606D', textAlign: 'left'}}>Residuals</h3>
              <p className="about-lang-intro">
              ...
              <h3 style={{fontSize: '1.3rem', fontWeight: '700', marginTop: '1.5rem', marginBottom: '0.5rem', color: '#40606D', textAlign: 'left'}}>Diluent</h3>
              <p className="about-lang-intro">
              ...
              <h3 style={{fontSize: '1.3rem', fontWeight: '700', marginTop: '1.5rem', marginBottom: '0.5rem', color: '#40606D', textAlign: 'left'}}>Adjuvant</h3>
              <p className="about-lang-intro">
              ...
              <p className="about-lang-intro" style={{fontSize: '0.9rem', fontStyle: 'italic', marginTop: '1.5rem'}}>
                Source: https://www.who.int/news-room/feature-stories/detail/how-are-vaccines-developed
              </p>
            </div>
          </div>
        </div>
