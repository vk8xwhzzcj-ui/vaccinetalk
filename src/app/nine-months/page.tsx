          ...
          <div className="about-bilingual">
            ...
            <div className="about-lang arabic">
              ...
              <div className="image-wrapper" style={{ marginBottom: '2rem', width: '100%', display: 'flex', justifyContent: 'center', background: 'transparent' }}>
                <img 
                  src="/9%20month%20old%20baby%20with%20black%20eyes%20not%20western%20but%20from%20egypt.jpeg" 
                  alt="تسع شهور" 
              ...
              <div className="about-lang-intro">
                <p>
                  التطعيمات المطلوبة في عمر التسع شهور، مقسمة إلى إجبارية وإضافية.
                </p>
              </div>
            ...
            <div className="about-lang">
              ...
              <div className="about-lang-intro">
                <p>
                  Required vaccines at nine months of age, divided into mandatory and additional.
                </p>
              </div>
